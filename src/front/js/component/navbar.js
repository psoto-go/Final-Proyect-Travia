...
export const Navbar = () => {
	...
	return (
		<nav className="navbar navbar-expand-lg navbar-light palNav colored pr-5">
			...
			<div className="collapse navbar-collapse colored" id="navbarSupportedContent colored ">
				<ul className="navbar-nav mr-auto colored">
					<li className="nav-item active colored">
						<Link to="/" className="btn  my-2 my-sm-0 colored text-white">
							Inicio
						</Link>
					</li>
					<li className="nav-item colored">
						<a className="nav-link colored text-white" href="#">
							Quienes somos
						</a>
					</li>
					<li className="nav-item colored">
